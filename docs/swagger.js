...
const options = {
    definition:{
       "openapi": "3.0.1",
        ...
        "servers": [
          {
            "url": "https://proyecto-backend-vial.onrender.com"
          }
        ],
        "tags": [
          {
        ...
        "paths": {
          ...
          "/reporte/{id}": {
            ...
            "put": {
              ...
              "responses": {
                "200": {
                  "description": "(OK) RActualizacion realizada con exito.",
                  "content": {
                    "application/json": {
                      "schema": {
          ...
          "/reportes/{id}": {
            "get": {
              ...
              "summary": "Permite obtener todos los Reportes se encuentren en la Base de Datos.",
              "parameters": [
              {
                "name": "id",
                "in": "path",
          ...
          "/reporte/actualizacionestado/{id}": {
            "put": {
              ...
              "parameters": [
                {
                  "$ref": "#/components/parameters/tokenAdmin"
                },
                {
                "name": "id",
                "in": "path",
        ...
        "components": {
          "parameters": {
            "token": {
              "name": "Authorization",
              "in": "header",
              "description": "Token de autenticación requerido usuario.",
              "required": true,
              "schema": {
                "type": "string",
            ...
            "tokenAdmin": {
              "name": "Authorization",
              "in": "header",
              "description": "Token de autenticación requerido administrador.",
              "required": true,
              "schema": {
                "type": "string",
                "example": "Bearer <token>"
